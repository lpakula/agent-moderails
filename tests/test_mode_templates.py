...
class TestAllModesRender:
    ...
    def task_context(self):
        ...
        return {
            ...
            "file_path": "_moderails/tasks/test-epic/test-task-abc123.plan.md",
            "has_plan_file": True,
            "type": "feature",
    ...
    def test_get_mode_with_task_context(self):
        ...
        context = {
            "current_task": {
                ...
                "file_path": "_moderails/tasks/test-task-abc123.plan.md",
                "type": "feature",
                "epic": None,
            }
        }
    ...
    def test_get_mode_in_progress_task(self):
        ...
        context = {
            "current_task": {
                ...
                "file_path": "_moderails/tasks/in-progress-task-xyz789.plan.md",
                "type": "feature",
                "epic": None,
            }
        }
    ...
    def test_complete_mode_with_git_state(self):
        ...
        context = {
            "current_task": {
                ...
                "file_path": "_moderails/tasks/test-abc123.plan.md",
                "type": "feature",
                "epic": None,
            },
            "git": {
    ...
    def test_execute_mode_no_confirmation_flag_renders_batch(self):
        ...
        context = {
            "current_task": {
                ...
                "name": "Test Task",
                "status": "in-progress",
                "file_path": "_moderails/tasks/test.plan.md",
                "type": "feature",
                "epic": None,
            },
