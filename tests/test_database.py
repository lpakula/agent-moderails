...
class TestEpicModel:
    ...
    def test_create_epic(self, test_db):
        ...
        epic = Epic(name="test-epic", tag="backend")
        test_db.add(epic)
        test_db.commit()
    ...
    def test_epic_to_dict(self, test_db):
        ...
        epic = Epic(name="test-epic", tag="api")
        test_db.add(epic)
        test_db.commit()
    ...
    def test_epic_unique_name(self, test_db):
        ...
        epic1 = Epic(name="duplicate", tag="")
        test_db.add(epic1)
        test_db.commit()
        
        epic2 = Epic(name="duplicate", tag="")
        test_db.add(epic2)
...
class TestTaskModel:
    ...
    def test_task_file_path_property(self, test_db):
        ...
        assert task.file_path == "moderails/tasks/my-epic/task.md"
    
    def test_task_status_enum(self, test_db):
        """Test TaskStatus enum values."""
        epic = Epic(name="test", tag="")
        test_db.add(epic)
        test_db.commit()
