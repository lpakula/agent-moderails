...
def alias_set(name, agent, model, flow_chain, project_id):
    ...
    \b
      moderails alias set fast --agent cursor --model sonnet-4.6 --flow default
      moderails alias set thorough -m sonnet-4.6-thinking -f react-js,submit-pr
      moderails alias set default -m sonnet-4.6-thinking
    """
