...
class ContextService:
    def __init__(self, project_dir: Path):
        """Initialize with the .moderails/ directory in a project or worktree."""
        self.project_dir = project_dir

    def get_current_flow(self) -> str:
        """Read the current flow from .moderails/flow. Defaults to 'default'."""
    ...
    def get_current_task_id(self) -> str:
        """Read the current task_id from .moderails/task_id."""
    ...
    def get_current_run_id(self) -> str:
        """Read the current run_id from .moderails/run_id."""
